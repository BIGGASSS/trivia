...
import { countryGamePath } from "@shared/game-constants";

const router = useRouter();

const startCountryGame = () => {
  void router.push(countryGamePath);
};
</script>
    ...
    <div class="hero" id="top">
      <div class="hero-copy">
        ...
        <p class="hero-description">
          Jump into quick map challenges, learn country locations, and build a streak as you explore
          the globe.
        </p>
